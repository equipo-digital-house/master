...
<header>
  <nav>
    <ul class="row">
      ...
      <li class="col-12 flex-column flex-md-row col-md-2 menu-items"><a href="registro.php">registro</a> </li>
      <li class="col-12 flex-column flex-md-row col-md-2 menu-items"><a href="login.php">login</a> </li>
