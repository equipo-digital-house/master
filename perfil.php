...
<body>
  <div class="container-fluid p-0">
    ...
    <main>
<div class="avatar">
  <img src="img/img_perfil/<?=$userSession["avatar"]?>" width="100" height="100"alt="">
</div>

      <h2 class="titulo">Mi Perfil</h2>
      <div class="row">
        <div class="col-12 col-lg-6 offset-lg-3 registro">
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
        <div class="card-body">
          <h4>Nombre Usuario:<?=$userSession["nombre"]?></h4>
